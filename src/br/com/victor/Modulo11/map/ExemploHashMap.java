 ...
 * @author Victor$
 * @date 26/08/2023$
 * Description: Permite chaves e valores null. Nãp existe garantia que os dados ficarão ordenados.
 *
 * Para usar uma classe que implementa Map, quaisquer classes que forem ultilizadas como chave
 * devem sobrescrever os métodos hasgCode() e equals().
 */
